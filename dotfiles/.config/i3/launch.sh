...
# start polybar
polybar left --config=$HOME/.config/i3/polybar/config.ini 2>&1 | tee -a /tmp/leftbar.log & disown
polybar center --config=$HOME/.config/i3/polybar/config.ini 2>&1 | tee -a /tmp/centerbar.log & disown
polybar right --config=$HOME/.config/i3/polybar/config.ini 2>&1 | tee -a /tmp/rightbar.log & disown
else
